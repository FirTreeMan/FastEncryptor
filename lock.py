...
textboxes.add(TextBox([305, 50], writable=False, title="", text="encrypt and compress your files", bgcolors=[bg, bg]),
              ...
              TextBox([25, 150], border=5, ident="locationE", reqs=[True, True], title="location", _screen='encrypt'),
              TextBox([25, 255], border=5, ident="passwordE", reqs=[True, False], title="password", _screen='encrypt'),
